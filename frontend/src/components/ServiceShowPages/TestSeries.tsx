        ...
        <section className="bg-gradient-to-r from-blue-500 to-purple-600 py-20 pt-[20vh] text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="mb-8 text-xl">
              Comprehensive mock test series for NEET and JEE (Main + Advanced)
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
              <Card className="transition-shadow duration-300 hover:shadow-lg">
                ...
                <CardContent>
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-center">
                      <CheckCircle className="mr-2 text-green-500" /> Physics
                      and Chemistry coverage
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="mr-2 text-green-500" />{" "}
              ...
              <Card className="transition-shadow duration-300 hover:shadow-lg">
                <CardHeader>
                  <CardTitle className="flex items-center text-2xl font-bold">
                    <Calculator className="mr-2" /> JEE (Main + Advanced)
                    Preparation
                  </CardTitle>
                  <CardDescription>
                ...
                <CardContent>
                  <ul className="space-y-2">
                    <li className="flex items-center">
                      <CheckCircle className="mr-2 text-green-500" /> In-depth
                      Mathematics coverage
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="mr-2 text-green-500" /> Advanced
                      Physics and Chemistry
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="mr-2 text-green-500" /> JEE Main
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                },
                {
                  ...
                  description:
                    "Simulates actual exam conditions for better preparation",
                },
                {
                  icon: <CheckCircle className="h-10 w-10" />,
                  title: "Detailed Analysis",
                  description:
                    "Get insights on your performance and areas of improvement",
                },
                {
                  icon: <Trophy className="h-10 w-10" />,
                  title: "Competitive Edge",
                  description:
                    "Compare your scores with peers across the country",
                },
              ].map((feature, index) => (
                <Card
                  key={index}
